...
var handlers = {
    ...
    'EndeIntent': function () {
        var speechOutput = 'Ok, dann machen wir Schluss. Du hast ' + this.attributes['correct'] + ' von ' + this.attributes['gamesPlayed'] + 'Aufgaben richtig gelöst.';
        var reprompt = 'Ok, dann mchen wir Schluss.';
